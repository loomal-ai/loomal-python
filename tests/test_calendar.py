...
class TestCalendarResource:
    ...
    def test_create(self):
        respx.post("https://api.loomal.ai/v0/calendar").mock(
        ...
        client = Loomal(api_key="mgent-test")
    ...
    @respx.mock
    def test_list(self):
        respx.get("https://api.loomal.ai/v0/calendar").mock(
    ...
    @respx.mock
    def test_get(self):
        respx.get("https://api.loomal.ai/v0/calendar/evt-1").mock(
            return_value=httpx.Response(200, json={
    ...
    def test_update(self):
        respx.patch("https://api.loomal.ai/v0/calendar/evt-1").mock(
            return_value=httpx.Response(200, json={
    ...
    def test_delete(self):
        respx.delete("https://api.loomal.ai/v0/calendar/evt-1").mock(
    ...
    def test_set_public(self):
        respx.post("https://api.loomal.ai/v0/calendar/public").mock(
